    ...
    if (/^\/api\/hermes\/config\/providers\/[^/]+\/editor$/.test(pathname)) {
      ...
      if (request.method() === 'PATCH') {
        ...
        providerEditor = {
          ...
          ...(body.extra_headers !== undefined ? { extra_headers: body.extra_headers } : {}),
          ...(body.preserve_client_identity !== undefined ? { preserve_client_identity: body.preserve_client_identity } : {}),
