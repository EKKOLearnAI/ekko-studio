...
export default {
  ...
  models: {
    ...
    orcaRouterLoginTitle: "OrcaRouter Login",
    orcaRouterModeLoopback: "Browser redirect",
    orcaRouterModeOob: "Paste a code",
    orcaRouterPreparing: "Preparing the OrcaRouter authorization request...",
    orcaRouterWaiting: "Approve the request in the OrcaRouter tab. This window closes automatically once the key is issued.",
    orcaRouterOpenLink: "Open OrcaRouter authorization page",
    orcaRouterCopyLink: "Copy authorization link",
    orcaRouterCodePlaceholder: "Authorization code",
    orcaRouterSubmitCode: "Submit code",
    orcaRouterApproved: "Connected to OrcaRouter.",
    orcaRouterDenied: "Authorization was denied in OrcaRouter.",
    orcaRouterExpired: "The authorization window closed. Start again.",
    orcaRouterFailed: "OrcaRouter authorization failed.",
    orcaRouterOobHint: "After approving, copy the code OrcaRouter displays and paste it here.",
    orcaRouterGetKey: "Get an OrcaRouter API key",
    orcaRouterCatalogDegraded: "OrcaRouter's live catalog is unavailable right now; showing the verified fallback model list.",
    orcaRouterModelIncompatible: "That model no longer supports this input type, so it was cleared. Pick another model.",
    orcaRouterCoverage: "Text and vision chat, workflows, auxiliary tasks, and coding agents.",
