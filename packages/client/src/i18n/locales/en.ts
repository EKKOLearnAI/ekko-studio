...
export default {
  jev: {
    ...
    memoryCandidateLimit: "Rerank candidate limit",
    memoryCandidateLimitHint: "1–50 cards per request; recommended: 20.",
    memoryMinConfidence: "Decision threshold",
    memoryMinConfidenceHint: "0.5–1; higher is more conservative. Recommended: 0.8. Uncertain results use the original flow.",
