...
export default {
  ...
  models: {
    ...
    preserveClientIdentity: 'Preserve Codex / Claude client identity',
    providerProxyUrl: 'Provider proxy URL (HTTP / HTTPS)',
    providerExtraHeaders: 'Extra request headers (JSON)',
    extraHeadersInvalid: 'Extra headers must be a JSON object with string values.',
