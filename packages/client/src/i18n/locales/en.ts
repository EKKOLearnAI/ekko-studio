...
export default {
  jev: {
    ...
    memoryOptionsHint: "Saved changes apply to the next run. Disabled or unavailable JEV preserves the original memory flow.",
    memoryDisabled: "Disabled; options are retained",
    memoryNoFeatures: "No enhancement selected",
    memoryReady: "Enabled for the selected features",
    memoryKindRouting: "Semantic category routing",
    memoryKindRoutingHint: "Find relevant memory categories beyond keyword matches.",
    memoryRerank: "Candidate reranking",
    memoryRerankHint: "Rank candidate memories before applying the context token budget.",
    memoryWriteReview: "Review memory writes",
    memoryWriteReviewHint: "Check user evidence, durability and category before committing the entire write batch.",
    memoryRelevanceFilter: "Filter unrelated memories",
    memoryRelevanceFilterHint: "Check ordinary memories individually for relevance, retaining standing constraints. Failed evaluations restore original recall.",
    memoryFilterMinConfidence: "Filter confidence",
    memoryFilterMinConfidenceHint: "0.5–1, default 0.8. Only discard irrelevant memories at or above this confidence; keep uncertain cards.",
    memoryAdvanced: "Advanced parameters",
    memoryCandidateLimit: "Recall candidate limit",
    memoryCandidateLimitHint: "Evaluate up to 1–50 cards per stage; recommended: 20.",
    memoryRecallMinConfidence: "Recall threshold",
    memoryRecallMinConfidenceHint: "0.5–1, default 0.5. Higher values recall fewer categories and require more certain rankings.",
    memoryMinConfidence: "Write review confidence",
    memoryMinConfidenceHint: "0.5–1, default 0.8. Uncertain reviews preserve the original write flow.",
    memoryTimeout: "Memory enhancement time budget (ms)",
    memoryTimeoutHint: "100–30000 ms; recommended: 3000. Total per recall or write batch; each request also obeys the connection timeout.",
    "ekkoMemoryEnabled": "Use JEV for Ekko memory",
  ...
  chat: {
    ...
    saveQueuedMessageEdit: 'Save queued message edit',
    cancelQueuedMessageEdit: 'Cancel queued message edit',
