...
export default {
  ...
  models: {
    ...
    orcaRouterLoginTitle: "OrcaRouter 登录",
    orcaRouterModeLoopback: "浏览器回调",
    orcaRouterModeOob: "粘贴授权码",
    orcaRouterPreparing: "正在准备 OrcaRouter 授权请求…",
    orcaRouterWaiting: "请在 OrcaRouter 标签页中确认授权。签发密钥后此窗口会自动关闭。",
    orcaRouterOpenLink: "打开 OrcaRouter 授权页面",
    orcaRouterCopyLink: "复制授权链接",
    orcaRouterCodePlaceholder: "授权码",
    orcaRouterSubmitCode: "提交授权码",
    orcaRouterApproved: "已连接 OrcaRouter。",
    orcaRouterDenied: "OrcaRouter 中已拒绝本次授权。",
    orcaRouterExpired: "授权窗口已关闭，请重新开始。",
    orcaRouterFailed: "OrcaRouter 授权失败。",
    orcaRouterOobHint: "授权后，请复制 OrcaRouter 显示的授权码并粘贴到此处。",
    orcaRouterGetKey: "获取 OrcaRouter API Key",
    orcaRouterCatalogDegraded: "当前无法读取 OrcaRouter 实时目录，正在显示已验证的备用模型列表。",
    orcaRouterModelIncompatible: "该模型已不支持此类输入，已清空，请重新选择模型。",
    orcaRouterCoverage: "文本与视觉对话、工作流、辅助任务与编码代理。",
    orcaRouterApiKeyLabel: "OrcaRouter API Key",
    orcaRouterConnect: "连接 OrcaRouter",
