...
export default {
  jev: {
    ...
    memoryOptionsHint: "保存后下一轮运行生效。关闭或 JEV 不可用时保持原记忆流程。",
    memoryDisabled: "已关闭，保留子项配置",
    memoryNoFeatures: "尚未选择增强功能",
    memoryReady: "已启用所选增强功能",
    memoryKindRouting: "语义分类辅助",
    memoryKindRoutingHint: "补充关键词未匹配到的相关记忆类别。",
    memoryRerank: "候选记忆重排",
    memoryRerankHint: "在应用上下文 token 预算前，按相关性排列候选记忆。",
    memoryWriteReview: "记忆写入校验",
    memoryWriteReviewHint: "整批写入提交前，检查用户证据、长期价值和分类。",
    memoryRelevanceFilter: "无关记忆过滤",
    memoryRelevanceFilterHint: "逐条排除与当前问题无关的普通记忆，保留必要约束；判断失败时使用原召回结果。",
    memoryFilterMinConfidence: "过滤判断置信度",
    memoryFilterMinConfidenceHint: "范围 0.5–1，默认 0.8。只排除达到阈值的无关记忆；不确定时保留该条。",
    memoryAdvanced: "高级参数",
    memoryCandidateLimit: "召回候选数量上限",
    memoryCandidateLimitHint: "每个阶段最多评估 1–50 条记忆，推荐 20 条。",
    memoryRecallMinConfidence: "召回判断阈值",
    memoryRecallMinConfidenceHint: "范围 0.5–1，默认 0.5。越高命中的分类越少，对重排置信度要求也越高。",
    memoryMinConfidence: "写入校验置信度",
    memoryMinConfidenceHint: "范围 0.5–1，默认 0.8。校验不确定时保留原写入流程。",
    memoryTimeout: "记忆增强总等待时间（毫秒）",
    memoryTimeoutHint: "范围 100–30000，推荐 3000。每次召回或整批写入的总上限；单次请求同时受连接超时限制。",
    "ekkoMemoryEnabled": "Ekko 记忆使用 JEV",
  ...
  chat: {
    ...
    saveQueuedMessageEdit: '保存排队消息修改',
    cancelQueuedMessageEdit: '取消排队消息修改',
