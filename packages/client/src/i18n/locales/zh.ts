...
export default {
  ...
  models: {
    ...
    preserveClientIdentity: '严格请求头（保留 Codex / Claude 客户端身份）',
    providerProxyUrl: '供应商连接代理（HTTP / HTTPS）',
    providerExtraHeaders: '额外请求头（JSON）',
    extraHeadersInvalid: '额外请求头必须是值为字符串的 JSON 对象。',
