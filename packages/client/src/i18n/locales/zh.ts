...
export default {
  jev: {
    ...
    memoryAdvanced: "高级参数",
    memoryCandidateLimit: "重排候选数量上限",
    memoryCandidateLimitHint: "每次请求 1–50 条，推荐 20 条。",
    memoryMinConfidence: "判断采纳门槛",
    memoryMinConfidenceHint: "范围 0.5–1，越高越保守，推荐 0.8。判断不确定时走原流程。",
