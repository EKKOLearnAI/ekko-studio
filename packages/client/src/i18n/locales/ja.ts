...
export default {
  ...
  models: {
    ...
    orcaRouterLoginTitle: "OrcaRouter ログイン",
    orcaRouterModeLoopback: "ブラウザリダイレクト",
    orcaRouterModeOob: "コードを貼り付け",
    orcaRouterPreparing: "OrcaRouter の認可リクエストを準備しています…",
    orcaRouterWaiting: "OrcaRouter のタブで承認してください。キーが発行されるとこのウィンドウは自動的に閉じます。",
    orcaRouterOpenLink: "OrcaRouter の認可ページを開く",
    orcaRouterCopyLink: "認可リンクをコピー",
    orcaRouterCodePlaceholder: "認可コード",
    orcaRouterSubmitCode: "コードを送信",
    orcaRouterApproved: "OrcaRouter に接続しました。",
    orcaRouterDenied: "OrcaRouter で認可が拒否されました。",
    orcaRouterExpired: "認可ウィンドウが閉じました。もう一度開始してください。",
    orcaRouterFailed: "OrcaRouter の認可に失敗しました。",
    orcaRouterOobHint: "承認後、OrcaRouter が表示するコードをコピーしてここに貼り付けてください。",
    orcaRouterGetKey: "OrcaRouter API キーを取得",
    orcaRouterCatalogDegraded: "現在 OrcaRouter のライブカタログを取得できません。検証済みのフォールバックモデル一覧を表示しています。",
    orcaRouterModelIncompatible: "このモデルはこの入力タイプに対応しなくなったため、選択を解除しました。別のモデルを選んでください。",
    orcaRouterCoverage: "テキストとビジョンのチャット、ワークフロー、補助タスク、コーディングエージェント。",
    orcaRouterApiKeyLabel: "OrcaRouter API キー",
    orcaRouterConnect: "OrcaRouter に接続",
