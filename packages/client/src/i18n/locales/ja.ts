...
export default {
  jev: {
    ...
    memoryCandidateLimit: "再ランキング候補数の上限",
    memoryCandidateLimitHint: "リクエストあたり 1～50 件。推奨値は 20 件。",
    memoryMinConfidence: "判断の採用しきい値",
    memoryMinConfidenceHint: "0.5～1。高いほど慎重に判断します。推奨値は 0.8。不確かな場合は元の処理を使用します。",
