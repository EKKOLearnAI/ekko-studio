...
export default {
  jev: {
    ...
    memoryCandidateLimit: "재정렬 후보 수 한도",
    memoryCandidateLimitHint: "요청당 1–50개, 권장값: 20.",
    memoryMinConfidence: "판단 채택 기준",
    memoryMinConfidenceHint: "0.5–1, 높을수록 보수적입니다. 권장값: 0.8. 불확실하면 기존 흐름을 사용합니다.",
