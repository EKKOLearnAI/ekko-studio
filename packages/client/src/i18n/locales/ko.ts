...
export default {
  ...
  models: {
    ...
    orcaRouterLoginTitle: "OrcaRouter 로그인",
    orcaRouterModeLoopback: "브라우저 리디렉션",
    orcaRouterModeOob: "코드 붙여넣기",
    orcaRouterPreparing: "OrcaRouter 인증 요청을 준비하는 중…",
    orcaRouterWaiting: "OrcaRouter 탭에서 승인하세요. 키가 발급되면 이 창은 자동으로 닫힙니다.",
    orcaRouterOpenLink: "OrcaRouter 인증 페이지 열기",
    orcaRouterCopyLink: "인증 링크 복사",
    orcaRouterCodePlaceholder: "인증 코드",
    orcaRouterSubmitCode: "코드 제출",
    orcaRouterApproved: "OrcaRouter에 연결되었습니다.",
    orcaRouterDenied: "OrcaRouter에서 인증이 거부되었습니다.",
    orcaRouterExpired: "인증 창이 닫혔습니다. 다시 시작하세요.",
    orcaRouterFailed: "OrcaRouter 인증에 실패했습니다.",
    orcaRouterOobHint: "승인 후 OrcaRouter가 표시하는 코드를 복사해 여기에 붙여넣으세요.",
    orcaRouterGetKey: "OrcaRouter API 키 받기",
    orcaRouterCatalogDegraded: "현재 OrcaRouter 실시간 카탈로그를 사용할 수 없어 검증된 대체 모델 목록을 표시합니다.",
    orcaRouterModelIncompatible: "이 모델은 더 이상 이 입력 유형을 지원하지 않아 선택이 해제되었습니다. 다른 모델을 선택하세요.",
    orcaRouterCoverage: "텍스트 및 비전 채팅, 워크플로, 보조 작업, 코딩 에이전트.",
    orcaRouterApiKeyLabel: "OrcaRouter API 키",
    orcaRouterConnect: "OrcaRouter 연결",
