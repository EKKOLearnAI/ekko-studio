...
export default {
  jev: {
    ...
    memoryOptionsHint: "저장한 변경 사항은 다음 실행부터 적용됩니다. 비활성화되거나 JEV를 사용할 수 없으면 기존 흐름을 유지합니다.",
    memoryDisabled: "비활성화됨, 개별 설정 유지",
    memoryNoFeatures: "선택한 강화 기능 없음",
    memoryReady: "선택한 강화 기능 활성화됨",
    memoryKindRouting: "의미 기반 분류 보조",
    memoryKindRoutingHint: "키워드가 놓친 관련 메모리 범주를 보완합니다.",
    memoryRerank: "후보 메모리 재정렬",
    memoryRerankHint: "컨텍스트 토큰 한도를 적용하기 전에 관련성 순으로 정렬합니다.",
    memoryWriteReview: "메모리 쓰기 검증",
    memoryWriteReviewHint: "일괄 쓰기를 확정하기 전에 사용자 근거, 지속성과 범주를 확인합니다.",
    memoryRelevanceFilter: "관련 없는 기억 필터링",
    memoryRelevanceFilterHint: "일반 기억의 관련성을 개별 판단하고 필수 제약은 유지합니다. 판단 실패 시 원래 검색 결과로 복원합니다.",
    memoryFilterMinConfidence: "필터 판단 신뢰도",
    memoryFilterMinConfidenceHint: "0.5–1, 기본값 0.8. 이 신뢰도 이상으로 무관하다고 판단한 기억만 제외하고 불확실한 기억은 유지합니다.",
    memoryAdvanced: "고급 매개변수",
    memoryCandidateLimit: "검색 후보 수 한도",
    memoryCandidateLimitHint: "단계당 최대 1–50개 기억을 평가합니다. 권장값: 20.",
    memoryRecallMinConfidence: "검색 판단 기준",
    memoryRecallMinConfidenceHint: "0.5–1, 기본값 0.5. 높을수록 선택되는 분류가 줄고 재정렬에 높은 신뢰도가 필요합니다.",
    memoryMinConfidence: "기록 검토 신뢰도",
    memoryMinConfidenceHint: "0.5–1, 기본값 0.8. 검토가 불확실하면 기존 기록 흐름을 유지합니다.",
    memoryTimeout: "메모리 강화 총 대기 시간(ms)",
    memoryTimeoutHint: "100–30000, 권장값: 3000. 검색 또는 일괄 쓰기별 총 한도이며 각 요청에는 연결 시간 제한도 적용됩니다.",
  ...
  chat: {
    ...
    saveQueuedMessageEdit: '대기 메시지 수정 저장',
    cancelQueuedMessageEdit: '대기 메시지 수정 취소',
